...
--------------------------------------------------------------*/
    $('.statistics').each(function () {
        ...
        $this.appear(function() {
            $('#speakers').animateNumber({ number: 741 }, 2000);
            $('#successfull-events').animateNumber({ number: 19430 }, 2000);
            $('#event-planers').animateNumber({ number: 583 }, 2000);
            $('#registrated-members').animateNumber({ number: 21457 }, 2000);
        });
    });
